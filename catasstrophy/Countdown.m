...
-(void)initializeBars
{
    ...
    self.chaosBarBackground.position=CGPointMake(tableWidth*self.size.width/568 - 40*self.size.width/568, tableHeight*self.size.height/320 + self.chaosBarBackground.size.height/2+5*self.size.width/568);
...
-(void)countdown
{
    self.countdownLabel = [SKLabelNode labelNodeWithFontNamed:@"Chalkduster"];
